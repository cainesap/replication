...
- example 1: beamer output
- example 2: html output
- example 3: interactive documents with Shiny
- example 4: paper packages
...
[Shiny & R Markdown](http://shiny.rstudio.com/articles/rmarkdown.html)
